...
#SBATCH --output=/p/project/chwu29/matthaei1/output/mapbind/processesOverMultiSocketsB-%j.log
...
srun --cpus-per-task=${SLURM_CPUS_PER_TASK} --distribution=block:cyclic:fcyclic \
