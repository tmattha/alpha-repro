...
#SBATCH --output=/p/project/chwu29/matthaei1/output/mapbind/processesOverMultiSocketsA-%j.log
...
srun --cpus-per-task=${SLURM_CPUS_PER_TASK} --distribution=block:fcyclic:fcyclic \
    dd_alpha_amg $PROJECT/matthaei1/alpha-repro/inis/mapbind/processesOverMultiSockets.ini
