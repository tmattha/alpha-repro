...
#SBATCH --output=/p/project/chwu29/matthaei1/output/mapbind/corePerformanceC-%j.log
...
srun --cpus-per-task=${SLURM_CPUS_PER_TASK} \
    dd_alpha_amg $PROJECT/matthaei1/alpha-repro/inis/mapbind/corePerformanceC.ini
