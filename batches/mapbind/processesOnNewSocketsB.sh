...
#SBATCH --output=/p/project/chwu29/matthaei1/output/mapbind/processesOnNewSocketsB-%j.log
...
srun --cpus-per-task=${SLURM_CPUS_PER_TASK} \
    dd_alpha_amg $PROJECT/matthaei1/alpha-repro/inis/mapbind/processesOnNewSocketsB.ini
