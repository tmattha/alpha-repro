...
#SBATCH --output=/p/project/chwu29/matthaei1/output/twonode_gmres_gpu-%j.log
...
srun --cpu-bind=rank_ldom ./dd_alpha_amg $PROJECT/matthaei1/alpha-repro/inis/twonode_gmres.ini
